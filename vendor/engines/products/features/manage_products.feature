...
Feature: Products
  ...
  Scenario: Create Valid Product
    ...
    And I fill in "Catalog Number" with "This is a test of the first string field"
    And I press "Save"
    Then I should see "'This is a test of the first string field' was successfully added."
    And I should have 1 product

  @products-invalid @invalid
  Scenario: Create Invalid Product (without catalog_number)
    When I go to the list of products
    And I follow "Add New Product"
    And I press "Save"
    Then I should see "Catalog Number can't be blank"
    And I should have 0 products

  @products-edit @edit
  Scenario: Edit Existing Product
    Given I have products titled "A catalog_number"
    When I go to the list of products
    And I follow "Edit this product" within ".actions"
    Then I fill in "Catalog Number" with "A different catalog_number"
    And I press "Save"
    Then I should see "'A different catalog_number' was successfully updated."
    And I should be on the list of products
    And I should not see "A catalog_number"
  ...
  Scenario: Create Duplicate Product
    ...
    When I go to the list of products
    And I follow "Add New Product"
    And I fill in "Catalog Number" with "UniqueTitleTwo"
    And I press "Save"
